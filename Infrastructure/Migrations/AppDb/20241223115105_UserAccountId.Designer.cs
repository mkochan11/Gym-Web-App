...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20241223115105_UserAccountId")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ApplicationCore.Entities.GroupTrainer", b =>
                {
                    b.HasBaseType("ApplicationCore.Entities.Employee");

                    b.HasDiscriminator().HasValue("GroupTrainer");
                });
            ...
            modelBuilder.Entity("ClientGroupTraining", b =>
                {
                    b.HasOne("ApplicationCore.Entities.GroupTraining", null)
                        .WithMany()
                        .HasForeignKey("GroupTrainingsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ApplicationCore.Entities.Client", null)
                        .WithMany()
