...
namespace Web.Pages.Admin.ZarzadzajUzytkownikami
{
    ...
    {
        private readonly IManageUsersViewModelService<GroupTrainer> _manageUsersViewModelService;
        private readonly IEmployeeService<GroupTrainer> _employeeService;
        private readonly UserManager<ApplicationUser> _userManager;
        private readonly IUserStore<ApplicationUser> _userStore;
        private readonly IUserEmailStore<ApplicationUser> _emailStore;

        public TrenerzyGrupowiModel(IManageUsersViewModelService<GroupTrainer> manageUsersViewModelService,
