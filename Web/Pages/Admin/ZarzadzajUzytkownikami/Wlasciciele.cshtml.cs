...
namespace Web.Pages.Admin.ZarzadzajUzytkownikami
{
    ...
    public class WlascicieleModel : PageModel
    {
        private readonly IManageUsersViewModelService<Owner> _manageUsersViewModelService;
        private readonly IEmployeeService<Owner> _employeeService;
        private readonly UserManager<ApplicationUser> _userManager;
        private readonly IUserStore<ApplicationUser> _userStore;
        private readonly IUserEmailStore<ApplicationUser> _emailStore;

        public WlascicieleModel(IManageUsersViewModelService<Owner> manageUsersViewModelService,
            IEmployeeService<Owner> employeeService,
