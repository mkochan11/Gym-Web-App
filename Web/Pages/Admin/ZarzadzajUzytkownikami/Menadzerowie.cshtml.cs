...
namespace Web.Pages.Admin.ZarzadzajUzytkownikami
{
    ...
    {
        private readonly IManageUsersViewModelService<Manager> _manageUsersViewModelService;
        private readonly IEmployeeService<Manager> _employeeService;
        private readonly UserManager<ApplicationUser> _userManager;
        private readonly IUserStore<ApplicationUser> _userStore;
        private readonly IUserEmailStore<ApplicationUser> _emailStore;

        public MenadzerowieModel(IManageUsersViewModelService<Manager> manageUsersViewModelService,
