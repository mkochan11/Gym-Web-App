...
namespace Web.Pages.Menadzer.Pracownicy
{
    ...
    {
        IManageEmployeesViewModelService<PersonalTrainer> _manageEmployeesViewModelService;
        private readonly IEmployeeService<PersonalTrainer> _employeeService;
        private readonly UserManager<ApplicationUser> _userManager;
        private readonly IUserStore<ApplicationUser> _userStore;
        private readonly IUserEmailStore<ApplicationUser> _emailStore;

        public TrenerzyPersonalniModel(IManageEmployeesViewModelService<PersonalTrainer> manageEmplyeesViewModelService,
        ...
        public async Task<IActionResult> OnPostCreate()
        {
            ...
            var registerResult = await _userManager.CreateAsync(user, AuthorizationConstants.DEFAULT_P_TRAINER_PASSWORD);
